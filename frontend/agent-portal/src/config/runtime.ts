import { DEMO_MERCHANTS, getDemoMerchant, type Merchant } from './merchantDemo'
...
export function getConfiguredMerchant(): Merchant {
...
export function getConfiguredAgent(): Agent {
  return { id: AGENT_ID, name: AGENT_NAME }
}

export function selectDemoMerchant(merchantId: string) {
